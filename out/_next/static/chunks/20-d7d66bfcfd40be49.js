  ...
  [20],
  {
    ...
    4724: function (e, t, r) {
      ...
      let y = o.default.forwardRef(function (e, t) {
          ...
          let w = o.default.useContext(c.RouterContext),
            M = o.default.useContext(f.AppRouterContext),
            U = null != w ? w : M,
            I = !w,
            L = !1 !== b,
            C = null === b ? g.PrefetchKind.AUTO : g.PrefetchKind.FULL,
            { href: k, as: T } = o.default.useMemo(() => {
              if (!w) {
                let e = formatStringOrUrl(l)
                return { href: e, as: m ? formatStringOrUrl(m) : e }
              }
              let [e, t] = (0, a.resolveHref)(w, l, !0)
              return { href: e, as: m ? (0, a.resolveHref)(w, m) : t || e }
            }, [w, l, m]),
            A = o.default.useRef(k),
            W = o.default.useRef(T)
          N && (n = o.default.Children.only(r))
          let D = N ? n && 'object' == typeof n && n.ref : t,
            [z, F, K] = (0, d.useIntersection)({ rootMargin: '200px' }),
            Q = o.default.useCallback(
              (e) => {
                ;(W.current !== T || A.current !== k) &&
                  (K(), (W.current = T), (A.current = k)),
                  z(e),
                  D &&
                    ('function' == typeof D
                      ? D(e)
          ...
          o.default.useEffect(() => {
            U && F && L && prefetch(U, k, T, { locale: O }, { kind: C }, I)
          }, [T, k, F, O, L, null == w ? void 0 : w.locale, U, I, C])
          let $ = {
            ref: Q,
            onClick(e) {
          ...
          if ((0, u.isAbsoluteUrl)(T)) $.href = T
          else if (!N || P || ('a' === n.type && !('href' in n.props))) {
            let e = void 0 !== O ? O : null == w ? void 0 : w.locale,
              t =
            ...
            $.href =
              t ||
              (0, h.addBasePath)(
                (0, s.addLocale)(T, e, null == w ? void 0 : w.defaultLocale),
              )
          }
          return N
            ? o.default.cloneElement(n, $)
            : o.default.createElement('a', { ...x, ...$ }, r)
        }),
        b = y
      ;('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
    ...
    622: function (e, t, r) {
      ...
      function q(e, t, r) {
        ...
        t))
          a.call(t, n) && !l.hasOwnProperty(n) && (u[n] = t[n])
        if (e && e.defaultProps)
