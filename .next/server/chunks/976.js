      ...
      function parseSetCookie(e) {
        ...
        let [[r, i], ...o] = parseCookie(e),
          ...
          p = {
            ...
            path: d,
            ...(c && {
              sameSite: n.includes((t = (t = c).toLowerCase())) ? t : void 0,
            }),
            ...(h && { secure: !0 }),
          }
        return (function (e) {
          ...
          if ((a && 'object' == typeof a) || 'function' == typeof a)
            for (let n of i(a))
              o.call(e, n) ||
                ...
                t(e, n, {
                  get: () => a[n],
                  enumerable: !(s = r(a, n)) || s.enumerable,
                })
          return e
          ...
          for (t = s, a = !1; skipWhitespace(); )
            if (',' === (r = e.charAt(s))) {
              ...
              s < e.length && '=' === e.charAt(s)
                ? ((a = !0), (s = o), n.push(e.substring(t, i)), (t = s))
                : (s = i + 1)
            } else s += 1
          ;(!a || s >= e.length) && n.push(e.substring(t, e.length))
        }
        return n
      }
      var s = class {
        ...
        l = class {
          constructor(e) {
            var t
            ;(this._parsed = new Map()), (this._headers = e)
            let r = null == (t = e.getSetCookie) ? void 0 : t.call(e)
            e.get('set-cookie')
            let i = Array.isArray(r) ? r : splitCookiesString(r)
            for (let e of i) {
              ...
              !(function (n, s) {
                var l = 'function',
                  ...
                  rgxMapper = function (e, t) {
                    for (var r, i, o, a, n, u, c = 0; c < t.length && !n; ) {
                      var h = t[c],
                        p = t[c + 1]
                      for (r = i = 0; r < h.length && !n && h[r]; )
                        if ((n = h[r++].exec(e)))
                          for (o = 0; o < p.length; o++)
                            (u = n[++i]),
                              typeof (a = p[o]) === d && a.length > 0
                                ? 2 === a.length
                                  ? typeof a[1] == l
                  ...
                  UAParser = function (e, t) {
                    ...
                    var r = typeof n !== u && n.navigator ? n.navigator : s,
                    ...
                    return (
                      ...
                      (this.getCPU = function () {
                        var e = {}
                        return (e[w] = s), rgxMapper.call(e, i, a.cpu), e
                      }),
                ...
                ;(UAParser.VERSION = '1.0.35'),
                  ...
                  typeof a !== u
                    ? (o.exports && (a = o.exports = UAParser),
                      (a.UAParser = UAParser))
                    : r.amdO
                    ? void 0 !==
                        (i = function () {
                    ...
                    : typeof n !== u && (n.UAParser = UAParser)
                var V = typeof n !== u && (n.jQuery || n.Zepto)
                if (V && !V.ua) {
                  var Z = new UAParser()
                  ;(V.ua = Z.getResult()),
                    (V.ua.get = function () {
  ...
  `)
    ...
    4192: (e, t, r) => {
      ...
      let NextURL = class NextURL {
        ...
        analyze() {
          var e, t, r, o, s
          let u = (0, n.getNextPathnameInfo)(this[l].url.pathname, {
              nextConfig: this[l].options.nextConfig,
              parseData: !0,
              i18nProvider: this[l].options.i18nProvider,
            }),
            d = (0, a.getHostname)(this[l].url, this[l].options.headers)
      ...
      let ImageResponse = class ImageResponse extends Response {
        ...
        constructor(...e) {
          let t = new ReadableStream({
              async start(t) {
                let i = (await Promise.resolve().then(r.bind(r, 4021)))
                    .ImageResponse,
                  o = new i(...e)
                if (!o.body) return t.close()
    ...
    2788: (e, t, r) => {
      ...
      let NextResponse = class NextResponse extends Response {
        constructor(e, t = {}) {
          super(e, t),
            (this[n] = {
              cookies: new a.ResponseCookies(this.headers),
              url: t.url
                ? new i.NextURL(t.url, {
                    headers: (0, o.toNodeOutgoingHttpHeaders)(this.headers),
                    nextConfig: t.nextConfig,
        ...
        static redirect(e, t) {
          ...
          let i = 'object' == typeof t ? t : {},
            a = new Headers(null == i ? void 0 : i.headers)
          return (
            a.set('Location', (0, o.validateURL)(e)),
            new NextResponse(null, { ...i, headers: a, status: r })
          )
        }
        static rewrite(e, t) {
      ...
      function detectDomainLocale(e, t, r) {
        if (e)
          for (let a of (r && (r = r.toLowerCase()), e)) {
            var i, o
            let e =
              null == (i = a.domain) ? void 0 : i.split(':')[0].toLowerCase()
            if (
              t === e ||
    ...
    4971: (e, t, r) => {
      ...
      let i = r(6242),
        o = r(6025)
      function addLocale(e, t, r, a) {
        if (!t || t === r) return e
        let n = e.toLowerCase()
        return !a &&
          ((0, o.pathHasPrefix)(n, '/api') ||
            (0, o.pathHasPrefix)(n, '/' + t.toLowerCase()))
          ? e
    ...
    6242: (e, t, r) => {
      ...
      function addPathPrefix(e, t) {
        ...
        let { pathname: r, query: o, hash: a } = (0, i.parsePath)(e)
        return '' + t + r + o + a
      }
    },
    256: (e, t, r) => {
    ...
    9387: (e, t, r) => {
      ...
      function getNextPathnameInfo(e, t) {
        ...
        s &&
          (0, a.pathHasPrefix)(d.pathname, s) &&
        ...
        if (l) {
          ...
          ;(d.locale = e.detectedLocale),
            (d.pathname = null != (n = e.pathname) ? n : d.pathname),
            !e.detectedLocale &&
              d.buildId &&
              (e = t.i18nProvider
    ...
    9128: (e, t, r) => {
      let i = {
        NextRequest: r(4793).NextRequest,
        NextResponse: r(2788).x,
        ImageResponse: r(7148).E,
        userAgentFromString: r(4263).userAgentFromString,
        userAgent: r(4263).userAgent,
      }
